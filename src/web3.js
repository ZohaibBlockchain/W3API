...
export async function LeverageTradeManager(inf, tokens) {
  try {
    ...
    let tx = await contract.tradeLeverage(tokenAddresses[0], tokenAddresses[1], inf.walletAddress,ethers.utils.parseUnits((inf.tokenAmount,6)), getside(inf.side), inf.orderID);
